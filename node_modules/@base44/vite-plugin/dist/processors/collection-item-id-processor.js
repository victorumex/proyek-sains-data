...
export class DataItemIdProcessor {
    ...
    processRootElement(path) {
        ...
        if (this.isMapCallbackFunction(fn))
            return;
    ...
    buildCollectionItemIdExpression(fn) {
        ...
        if (firstParam.isIdentifier()) {
            ...
            return this.types.optionalMemberExpression(this.types.identifier(firstParam.node.name), this.types.stringLiteral(DATA_COLLECTION_ITEM_ID), true, // computed
            true // optional
            );
        }
        return null;
